...
const palette = {
  ...
  'es-ref-palette-secondary10': '#09224D',
  'es-ref-palette-secondary20': '#0F3880',
  'es-ref-palette-secondary30': '#144EB2',
  'es-ref-palette-secondary40': '#1D70FF',
  'es-ref-palette-secondary50': '#669EFF',
  'es-ref-palette-secondary60': '#80AEFF',
  'es-ref-palette-secondary70': '#9CC0FF',
  'es-ref-palette-secondary80': '#CFE0FF',
  'es-ref-palette-secondary90': '#E8F0FF',
  ...
  'es-ref-palette-tertiary10': '#891F10',
  'es-ref-palette-tertiary20': '#B64C3D',
  'es-ref-palette-tertiary30': '#CF5543',
  'es-ref-palette-tertiary40': '#EA5D49',
  'es-ref-palette-tertiary50': '#EF8576',
  'es-ref-palette-tertiary60': '#F19386',
  'es-ref-palette-tertiary70': '#F4ADA4',
  'es-ref-palette-tertiary80': '#F8C9C2',
  'es-ref-palette-tertiary90': '#FCEBE8',
  ...
  'es-ref-palette-neutral95': '#F7F7F7',
...
const color_system = {
  ...
  'es-sys-color-lm-secondary': palette['es-ref-palette-secondary30'],
  'es-sys-color-lm-secondary-hover': palette['es-ref-palette-secondary20'],
  'es-sys-color-lm-secondary-click': palette['es-ref-palette-secondary10'],
  ...
  'es-sys-color-lm-inverse-on-secondary': palette['es-ref-palette-secondary30'],
  ...
  'es-sys-color-lm-outline-secondary': palette['es-ref-palette-secondary30'],
  ...
  'es-sys-color-tertiary-00': palette['es-ref-palette-tertiary00'],
  'es-sys-color-tertiary-0': palette['es-ref-palette-tertiary0'],
  'es-sys-color-tertiary-10': palette['es-ref-palette-tertiary10'],
  'es-sys-color-tertiary-20': palette['es-ref-palette-tertiary20'],
  'es-sys-color-tertiary-30': palette['es-ref-palette-tertiary30'],
  'es-sys-color-tertiary-40': palette['es-ref-palette-tertiary40'],
  'es-sys-color-tertiary-50': palette['es-ref-palette-tertiary50'],
  'es-sys-color-tertiary-60': palette['es-ref-palette-tertiary60'],
  'es-sys-color-tertiary-70': palette['es-ref-palette-tertiary70'],
  'es-sys-color-tertiary-80': palette['es-ref-palette-tertiary80'],
  'es-sys-color-tertiary-90': palette['es-ref-palette-tertiary90'],
  'es-sys-color-tertiary-100': palette['es-ref-palette-tertiary100'],
  'es-sys-color-tertiary-101': palette['es-ref-palette-tertiary101'],
  ...
  'es-sys-color-neutral-95': palette['es-ref-palette-neutral95'],
...
const ColorsTW = {
  ...
  'tertiary-00': color_system['es-sys-color-tertiary-00'],
  'tertiary-0': color_system['es-sys-color-tertiary-0'],
  'tertiary-10': color_system['es-sys-color-tertiary-10'],
  'tertiary-20': color_system['es-sys-color-tertiary-20'],
  'tertiary-30': color_system['es-sys-color-tertiary-30'],
  'tertiary-40': color_system['es-sys-color-tertiary-40'],
  'tertiary-50': color_system['es-sys-color-tertiary-50'],
  'tertiary-60': color_system['es-sys-color-tertiary-60'],
  'tertiary-70': color_system['es-sys-color-tertiary-70'],
  'tertiary-80': color_system['es-sys-color-tertiary-80'],
  'tertiary-90': color_system['es-sys-color-tertiary-90'],
  'tertiary-100': color_system['es-sys-color-tertiary-100'],
  'tertiary-101': color_system['es-sys-color-tertiary-101'],
  ...
  'neutral-95': color_system['es-sys-color-neutral-95'],
